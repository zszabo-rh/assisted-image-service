...
- `IMAGE_WORKERS` - number of images being processed in parallel during the container startup phase. Higher number results in shorter startup time but requires more storage space. Default is 1.
